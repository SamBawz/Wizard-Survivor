...
global.elements = [ 
	...
	{id: 4, name: "Air", description: "Become invulnerable while riding gusts of wind, damaging nearby enemies and improving your mobility", icon: "sAirIcon", button: "sAirButton", obtainable: true},
